...
import model.structures.SensorDetails;

public abstract class AbstractSensor<T extends Object> extends Observable<Object> implements ISensor {
	...
	{
		if (!(observer instanceof ArduinoSensor))
		{
