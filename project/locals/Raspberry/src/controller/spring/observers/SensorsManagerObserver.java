...
public class SensorsManagerObserver implements Observer<Object>{
	...
	@Autowired
	private ArrayList<SensorsManager> sensorsManagers;
	...
	public void subscribe()
	{
		...
		sensorsManagers.forEach(manager->manager.subscribe(this));
	...
	public void unsubscribe()
	{
		...
		sensorsManagers.forEach(manager->manager.disconnectObserver(this));
		subscribed=false;
