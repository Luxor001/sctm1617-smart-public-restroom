...
L'applicazione, infatti, sarà comunque utilizzabile come un normale sito web: soltanto alcuni aspetti avanzati, come l'installazione nativa, potranno risultare incompatibili.

\phantom{}
\begin{figure}
\centering
  \includegraphics[scale=0.25]{img/mockup-consumer.png}
  \caption{Mockup di \textit{manager}}
\end{figure}
\newpage
