...
Molto più preoccupante è la robustezza del software; in una prima versione del progetto la gestione degli errori è stata ridotta all'osso. Questo significa che per qualsiasi malfunzionamento l'applicazione lato raspberry potrebbe rompersi; occorre quindi un riavvio dell'applicazione da remoto per ristabilire il corretto funzionamento del sistema.
\newpage
