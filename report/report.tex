...
\paragraph{API}
Strutturalmente, il server è strutturato da una serie di file chiamati \textit{controller} che separano le API dedicate di ogni parte logica del sistema.\\
