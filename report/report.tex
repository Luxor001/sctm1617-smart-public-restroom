...
\item Avendo già sviluppato prodotti di una certa complessità attraverso questo framework, il team di sviluppo è riuscito a rimanere particolarmente efficiente.
\end{itemize}
%L'applicazione è stata scritta in Typescript, linguaggio di nuova concezione per lo sviluppo frontend che permette di scrivere
\subsubsection{Consumer}
\subsection{Implementazione parte Server}
\newpage
