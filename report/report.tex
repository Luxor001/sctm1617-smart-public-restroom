...
Il capitolo di progettazione di \textit{manager }prevedeva lo sviluppo di una applicazione web SPA di una certa complessità.\\
Con questi requisiti, il team di sviluppo ha deciso di adottare \textit{Angular} come framework di sviluppo per il prodotto.
\subsubsection{Consumer}
\newpage
